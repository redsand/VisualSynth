...
export interface RenderState
  ...
  assetVortexEnabled: boolean;
  assetVortexOpacity: number;
  assetVortexStrength: number;
  assetVortexSpeed: number;
  assetSlicesEnabled: boolean;
  assetSlicesOpacity: number;
  assetSlicesCount: number;
  assetSlicesShift: number;
  assetPolarEnabled: boolean;
  assetPolarOpacity: number;
  assetPolarRadius: number;
  assetPolarTwist: number;
  assetMosaicEnabled: boolean;
  assetMosaicOpacity: number;
  assetMosaicTiles: number;
  assetMosaicFlip: number;
  assetRippleEnabled: boolean;
  assetRippleOpacity: number;
  assetRippleAmplitude: number;
  assetRippleFrequency: number;
  assetScatterEnabled: boolean;
  assetScatterOpacity: number;
  assetScatterAmount: number;
  assetScatterSeed: number;
  assetEchoEnabled: boolean;
  assetEchoOpacity: number;
  assetEchoCount: number;
  assetEchoSpread: number;
  assetEchoFade: number;
